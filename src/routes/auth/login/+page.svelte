						...
						>
							<div class="form-control">
								<label class="label" for="identity">
									<span class="label-text font-medium text-base-content"
										>Username atau Nomor Kontak</span
									>
								</label>
								<input
									id="identity"
									...
									minlength="3"
									maxlength="31"
									class="input input-bordered bg-base-100 text-base-content placeholder-base-content/50 focus:ring-2 focus:ring-primary/20 {loginErrors.identity
										? 'input-error'
										: ''}"
							...
							<div class="form-control">
								...
								<input
									...
									minlength="6"
									maxlength="255"
									class="input input-bordered bg-base-100 text-base-content placeholder-base-content/50 focus:ring-2 focus:ring-primary/20 {loginErrors.password
										? 'input-error'
										: ''}"
						...
						>
							<div class="form-control">
								...
								<input
									...
									minlength="2"
									maxlength="100"
									class="input input-bordered bg-base-100 text-base-content placeholder-base-content/50 focus:ring-2 focus:ring-primary/20 {registerErrors.fullName
										? 'input-error'
										: ''}"
							...
							<div class="form-control">
								...
								<input
									...
									minlength="10"
									maxlength="15"
									class="input input-bordered bg-base-100 text-base-content placeholder-base-content/50 focus:ring-2 focus:ring-primary/20 {registerErrors.contactNumber
										? 'input-error'
										: ''}"
							...
							<div class="form-control">
								...
								<input
									...
									minlength="6"
									maxlength="255"
									class="input input-bordered bg-base-100 text-base-content placeholder-base-content/50 focus:ring-2 focus:ring-primary/20 {registerErrors.password
										? 'input-error'
										: ''}"
									placeholder="Masukkan kata sandi"
							...
							<button
								class="btn btn-lg rounded-full w-full bg-base-content text-primary border border-primary hover:bg-primary hover:text-primary-content {isLoading
									? 'loading'
									: ''}"
								type="submit"
								disabled={isLoading}
